...
//and they can go over classes, methods, and variables, depending on the annotation
class Bird extends Animal {
	...
	//Deprecated marks a method as being phased out and shouldnt be used
	@Deprecated
...
@MyAnnotation(AString="",AnotherString="")
class newBird extends Bird{
	
	//SuppressWarnings prevents certain warnings in certain contexts
